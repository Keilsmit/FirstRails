class WelcomeController < ApplicationController
  ...
  def lorem
    ...
    if @lorem == "samuel"
      ...
      @selection =  "Choose between samuel, hipster or classic"
    end
    @paragraph = (params[:paragraph] || 1).to_i
  end
end
